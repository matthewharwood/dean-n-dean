...
export const ALCHEMY_RECIPES = [
  ...
  recipe({
    ...
    arguments: [arg("material:glass", 2)],
    station: "glassworks",
    action: "shape",
    progression: progress(2, 8, 4, 0.22),
    education: lesson(
      ["container", "material properties"],
      "A flask uses more glass than a tube, and glass is hard and does not soak up water.",
      "adult-supervision",
    ),
  ...
  recipe({
    ...
    arguments: [arg("component:glass-tube", 1), arg("material:charcoal", 1, "fuel")],
    station: "glassworks",
    action: "heat",
    progression: progress(3, 12, 4, 0.32),
    education: lesson(
      ["drawn bead", "hot tumbling"],
      "Drawn glass beads are cut from glass tubes, then reheated or hot-tumbled to round their edges.",
      "adult-supervision",
    ),
  ...
  recipe({
    ...
    arguments: [arg("material:iron-ingot", 2)],
    station: "forge",
    action: "shape",
  ...
  recipe({
    ...
    arguments: [arg("material:bronze-ingot", 2)],
    station: "forge",
    action: "shape",
  ...
  recipe({
    ...
    arguments: [arg("material:silver-ingot", 2)],
    station: "forge",
    action: "shape",
  ...
  recipe({
    ...
    arguments: [arg("material:gold-ingot", 2)],
    station: "forge",
    action: "shape",
