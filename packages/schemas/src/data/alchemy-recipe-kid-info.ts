...
export const ALCHEMY_RECIPE_KID_INFO_SOURCES = [
  ...
  source(
    "source:charcoal-kiln",
    "Charcoal Kilns - National Park Service",
    "https://home.nps.gov/deva/learn/historyculture/charcoalkilns.htm",
  ),
  source(
    "source:shaft-straightener",
    "Shaft Straightener - National Park Service",
    "https://www.nps.gov/museum/exhibits/jotr/Desert-Peoples/Native-Peoples/JOTR-5330A.html",
  ),
  source(
    "source:wire-drawbench",
    "Metal Wire Drawing - Victoria and Albert Museum",
    "https://www.vam.ac.uk/blog/caring-for-our-collections/all-that-glitters-part-3-manufacturing-techniques",
  ),
  source(
    "source:rivet-heading",
    "Copper Rivet Production - U.S. International Trade Commission",
    "https://www.usitc.gov/publications/safeguards/pub270.pdf",
  ),
  source(
    "source:needle-making",
    "Historic Needle Making - Historic England",
    "https://historicengland.org.uk/listing/the-list/list-entry/1301058?section=overview",
  ),
  source(
    "source:forged-arrowhead",
    "Forged Iron Arrowhead - British Museum",
    "https://www.britishmuseum.org/collection/object/X__4132",
  ),
...
export const ALCHEMY_RECIPE_KID_INFO = [
  ...
  kidInfo(
    ...
    "Charcoal",
    [
      "A charcoal kiln heats wood while keeping most air away, leaving carbon-rich fuel instead of ordinary ash.",
      "The Kiln is the treatment that changes Wood into Charcoal; it is not another ingredient that gets used up.",
      "Charcoal matters because the forge and glassworks need strong, steady heat before they can wake up.",
    ],
    ["source:charcoal", "source:charcoal-kiln"],
  ),
  kidInfo(
    "alchemy:ash",
    "Ash",
  ...
  kidInfo(
    ...
    "Copper Wire",
    [
      "A drawbench pulls copper stock through a drawplate, using smaller holes to make long, thin wire.",
      "Copper can carry electricity well, so the wire is like a road for energy.",
      "The Wire Drawbench explains why two Copper Ingots become Wire instead of Rivets in the guild model.",
    ],
    ["source:copper", "source:conductor", "source:wire-drawbench"],
  ),
  kidInfo(
    "alchemy:glass-bead",
    "Glass Bead",
  ...
  kidInfo(
    ...
    "Steel Needle",
    [
      "Historic needle mills drew steel into wire, straightened and cut it, formed the eye, then hardened and polished it.",
      "Steel can hold a sharper, tougher point than soft iron, like a pencil point that does not crumble.",
      "Choosing the Needle Mill keeps the same steel stock from becoming a forged Arrowhead instead.",
    ],
    ["source:steel", "source:needle-making"],
  ),
  kidInfo(
    "alchemy:copper-rivet",
    "Copper Rivet",
    [
      "A Rivet Header cuts metal stock and upsets one end in a die to form the rivet head.",
      "Rivets hold pieces together like tiny metal buttons after the other end is headed during assembly.",
      "The Rivet Header—not a fake extra ingredient—is what makes copper stock become Rivets instead of Wire.",
    ],
    ["source:copper", "source:rivet-heading"],
  ),
  kidInfo(
  ...
  kidInfo(
    ...
    "Wood Shaft",
    [
      "A grooved shaft straightener can warm and press a bent wooden shaft into a straighter shape.",
      "Wood has grain, which is like tiny lines that help decide how it bends and breaks.",
      "Choosing the Shaft Straightener makes a Shaft; choosing the Kiln changes the same Wood into Charcoal.",
    ],
    ["source:shaft-straightener"],
  ),
  kidInfo(
    ...
    "Ranger Arrowhead",
    [
      "A Ranger Arrowhead is a hard wedge-shaped point forged with heat, a hammer, and an anvil.",
      "A wedge focuses force into a small area, like the tip of a pencil pressing into paper.",
      "Choosing Forge & Anvil makes the Arrowhead; choosing the Needle Mill turns the same steel stock into a Needle.",
    ],
    ["source:steel", "source:forged-arrowhead"],
  ),
  kidInfo(
